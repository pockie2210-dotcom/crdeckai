...
const SmartAI = (() => {
    ...
    const SYNERGIES = [
        ...
        { cards: ['Hog Rider', 'Ice Golem'], tier: 'S', desc: "Pig Push: Ice Golem tanks and pushes Hog past buildings." },
        { cards: ['Hog Rider', 'Earthquake'], tier: 'S', desc: "Hard Counter: EQ destroys Tesla/Cannon before they stop the Hog." },
        { cards: ['Golem', 'Night Witch'], tier: 'S', desc: "Beatdown Core: NW's bats swarm behind the Golem. Deadly if not answered." },
        { cards: ['Lava Hound', 'Balloon'], tier: 'S', desc: "LavaLoon: Hound tanks, Balloon deals the damage. Classic air dominance." },
        { cards: ['Miner', 'Wall Breakers'], tier: 'S', desc: "Speed Cycle: Miner tanks tower shots allowing WBs to connect." },
        { cards: ['Miner', 'Poison'], tier: 'S', desc: "Miner Control: Chip damage + area denial for defending troops." },
        { cards: ['X-Bow', 'Tesla'], tier: 'S', desc: "Siege Fortress: Tesla protects X-Bow from tanks and swarms." },
        { cards: ['Tornado', 'Executioner'], tier: 'S', desc: "Exenado: Tornado clumps targets; Exe hits them all twice. Perfect defense." },
        { cards: ['Goblin Barrel', 'Princess'], tier: 'S', desc: "Log Bait: They can only Log one. The other punishments." },
        { cards: ['Royal Giant', 'Fisherman'], tier: 'S', desc: "RG Protector: Fisherman pulls Pekka/Mini Pekka away from the RG." },
        { cards: ['Electro Giant', 'Tornado'], tier: 'S', desc: "Zap Reflex: Pulls ranged units into E-Giant's zap reflection radius." },
        { cards: ['Goblin Drill', 'Bomber'], tier: 'S', desc: "Drill Cycle: Bomber splashes defenders trying to catch the Drill." },
        { cards: ['Royal Recruits', 'Royal Hogs'], tier: 'S', desc: "Fireball Bait: Overwhelms both lanes. If they Fireball one, the other wins." },

        // A-TIER (Strong Meta Combos)
        { cards: ['P.E.K.K.A', 'Battle Ram'], tier: 'A', desc: "Bridge Spam: Pekka defends, Ram counter-pushes instantly." },
        { cards: ['Giant', 'Prince'], tier: 'A', desc: "Double Prince Giant: Charge mechanics overwhelm standard defenses." },
        { cards: ['Mega Knight', 'Zap'], tier: 'A', desc: "MK Entry: Zap resets Infernos and kills Bats to save the MK." },
        { cards: ['Balloon', 'Lumberjack'], tier: 'A', desc: "LumberLoon: Rage drop speeds up the Balloon connection." },
        { cards: ['Sparky', 'Goblin Giant'], tier: 'A', desc: "Goblin Giant provides a moving shield for the Sparky." },
        { cards: ['Graveyard', 'Freeze'], tier: 'A', desc: "GY Freeze: High risk, high reward. Tower melting potential." },
        { cards: ['Lava Hound', 'Flying Machine'], tier: 'A', desc: "Air Support: Flying Machine snipes from safety behind the Hound." },
        { cards: ['Magic Archer', 'Tornado'], tier: 'A', desc: "Geometry: Aligns enemies for Magic Archer chip damage." },
        { cards: ['Elixir Golem', 'Battle Healer'], tier: 'A', desc: "Blob Spam: Healer keeps Egolem alive. Toxic synergy." },
        { cards: ['Mortar', 'Skeleton King'], tier: 'A', desc: "Mortar Bait: Skeleton King farms souls from bait cards for a huge push." },
